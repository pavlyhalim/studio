// src/components/dashboard/student/study-planner-dialog.tsx
...
import type { CourseRecord, AssignmentRecord } from '@/lib/models';
    ...
    try {
      const result = await generateStudyPlan({
        ...
        upcomingAssignments: upcomingAssignments?.map(a => ({
          id: a.id,
          title: a.title,
          dueDate: a.dueDate instanceof Date 
            ? a.dueDate.toISOString() 
            : new Date(a.dueDate as number).toISOString(),
      ...
      <DialogContent className="sm:max-w-[600px]">
        ...
        <DialogFooter>
          {!plan ? (
            ...
            <>
              <Button variant="outline" onClick={() => setPlan(null)} className="w-full sm:w-auto">
                Generate New Plan
              </Button>
